...
import 'package:connectapp/presentation/upload_post/widgets/media_picker.dart';
import 'package:connectapp/presentation/upload_post/widgets/post_bottom_sheet.dart';
...
class _PostViewState extends State<PostView> {
  ...
  uploadFile() async {
    for (var i in _mediaFiles) {
      var imageUrl =
      await firestoreService.uploadFile(File(i['mediaFile']));
